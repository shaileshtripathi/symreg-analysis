...
Once everything is working, participants can basically sit tight: the competition organizers will then set about testing the methods on a variety of datasets. 
...
The competition consists of two separate and independent tracks (a method can, in principle, win both): the *Synthetic* track and the *Real-World* track.
...
### Hyperparameter Tuning (Alternative description with max_time in the code)
